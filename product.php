...
<?php
        ...
        if (isset($_SESSION['cart_p_id'])) {
            ...
            if ($added == 1) {
                ...
                $_SESSION['cart_p_SellerID'][$new_key] = $_POST['SellerID'];
            ...
            $_SESSION['cart_p_SellerID'][1] = $_POST['SellerID'];
            $success_message1 = 'Product is added to the cart successfully!';
        }
    endif;
}
            ...
            <div class="col-md-12">
                <div class="breadcrumb mb_30">
                    <ul>
                        <li><a href="">Home</a></li>
                        <li>></li>
                        <li><a href="<?php echo 'product-category.php?id=' . $tcat_id . '&type=top-category' ?>"><?php echo $tcat_name; ?></a></li>
                        <li>></li>
                        <li><a href="<?php echo 'product-category.php?id=' . $mcat_id . '&type=mid-category' ?>"><?php echo $mcat_name; ?></a></li>
                        <li>></li>
                        <li><a href="<?php echo 'product-category.php?id=' . $ecat_id . '&type=end-category' ?>"><?php echo $ecat_name; ?></a></li>
                        <li>></li>
                ...
                <div class="product">
                        ...
                        <div class="col-md-7">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="p-price">
                                    ...
                                    <span>
                                        <?php if ($p_old_price != '') : ?>
                                            <del><?php echo "Rp."; ?><?php echo $p_old_price; ?></del>
                                        <?php endif; ?>
                                        <?php echo "Rp."; ?><?php echo $p_current_price; ?>
                                    </span>
                                </div>
                                ...
                                <div class="p-sold">
                                    <?php echo "Sold"; ?> <br>
                                    <div><?php
                                            $statement = $pdo->prepare("SELECT quantity FROM tbl_product JOIN tbl_order ON tbl_product.p_id = tbl_order.product_id WHERE tbl_order.product_id=?");
                                            $statement->execute(array($_REQUEST['id']));
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                            $sold_times = 0;
                                            foreach ($result as $row) {
                                                $sold_times += $row['quantity'];
                                            }
                                            echo $sold_times . ' times';
                                            ?>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-tabs" role="tablist" style="display: flex;justify-content: space-around;">
                                <li role="presentation" class="active">
                                    <a href="#description" aria-controls="description" role="tab" data-toggle="tab" class="active show"><?php echo "Product Description"; ?></a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="review" style="margin-top: -30px;">
                                    ...
                                    <div class="review-form">
                                        ...
                                        <?php
                                        $bought = 0;
                                        $statement = $pdo->prepare("SELECT customer_id from tbl_payment JOIN (SELECT payment_id FROM tbl_product JOIN tbl_order ON tbl_product.p_id = tbl_order.product_id WHERE tbl_order.product_id = ?) as alias_payment on tbl_payment.payment_id = alias_payment.payment_id where customer_id = ?
                                            ");
                                        ...
                                        if (isset($_SESSION['customer']) && $bought) :
                                            $statement = $pdo->prepare("SELECT * 
                                                                FROM tbl_rating
                                        ...
                                        <?php else : ?>
                                            ...
                                            <?php } else { ?>
                                                <p class="error">
                                                    <?php echo "You must buy the product first to review"; ?>
                                                </p>
                                            <?php } ?>
                                        <?php endif; ?>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="headline">
                        ...
                        <h3><?php echo "See all the related products below"; ?></h3>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        ?>
                            <div class="item">
                                ...
                                <div class="text">
                                    ...
                                    <h4>
                                        <?php echo "Rp."; ?><?php echo $row['p_current_price']; ?>
                                        <?php if ($row['p_old_price'] != '') : ?>
                                            <del>
                                                <?php echo "Rp."; ?><?php echo $row['p_old_price']; ?>
                                            </del>
                                        <?php endif; ?>
                                    </h4>
                                    <div class="rating">
                                    ...
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>&Seller<?= $row['SellerID']; ?>"><?php echo "Add to Cart"; ?></a></p>
                                </div>
                            </div>
                        <?php
                        }
