        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (!isset($_SESSION['cart_p_id'])) : ?>
                    ...
                    <div class="shop-button" style="display: flex; justify-content:center; margin: 2rem 0;">
                        <a href="./product-category.php?id=1&type=top-category" style="margin: auto;"><button class="btn btn-primary">Shop Now</button></a>
                    </div>
                <?php else : ?>
                    <form action="" method="post">
                            ...
                            <table class="table table-responsive table-hover table-bordered">
                                ...
                                <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo "Rp."; ?><?php echo $arr_cart_p_current_price[$i]; ?></td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            ?>
                                            <?php echo "Rp."; ?><?php echo $row_total_price; ?>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <th class="total-amount"><?php echo "Rp."; ?><?php echo $table_total_price; ?></th>
                                    <th></th>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="cart-buttons">
                            <ul>
                                ...
                                <li><a href="product-category.php?id=1&type=top-category" class="btn btn-primary"><?php echo "Continue Shopping"; ?></a></li>
