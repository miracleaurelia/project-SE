...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $message = '<p>'."To reset your password, please click on the link below.".'<br> <a href="'.'http://127.0.0.1/gotostore-php/reset-password.php?email='.$_POST['cust_email'].'&token='.$token.'">Click here</a>';
        ...
        $to      = $_POST['cust_email'];
        $subject = "PASSWORD RESET REQUEST - GoToStore";
...
<div class="page-banner" style="background-color:#444;background-image: url(assets/uploads/<?php echo $banner_forget_password; ?>);">
    <div class="inner">
        <h3><?php echo "Forget Password"; ?></h3>
    </div>
</div>
