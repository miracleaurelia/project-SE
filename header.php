...
<head>
	...
	if ($cur_page == 'index.php' || $cur_page == 'login.php' || $cur_page == 'registration.php' || $cur_page == 'cart.php' || $cur_page == 'checkout.php' || $cur_page == 'forget-password.php' || $cur_page == 'reset-password.php' || $cur_page == 'product-category.php' || $cur_page == 'product.php' || $cur_page == 'profile.php') {
	?>
	...
	<?php if ($cur_page == 'index.php' || $cur_page == 'product.php') : ?>
...
<div id="preloader">
			...
			<div class="row inner">
				...
				<div class="col-md-5 right">
					<ul>
						...
						<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo "Cart"; ?> (<?php echo "Rp."; ?><?php
	...
	<header class="header trans_300" style="z-index: 99999;">
		<div class="main_nav_container">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-right">
						<div class="logo_container">
							<a href="#">GOTO<span>STORE</span></a>
						</div>
						<nav class="navbar">
							<ul class="navbar_menu">
								<li><a href="./index.php">Home</a></li>
								<li><a href="./product-category.php?id=1&type=top-category">Shop</a></li>
								<li><a href="./customer-order.php">History</a></li>
								<li><a href="./select.php">Forum</a></li>
								<li><a href="./image-upload.php">Image Upload</a></li>
								<li><a href="./contact.php">contact</a></li>
							</ul>
							<ul class="navbar_user">
								<?php
								if (isset($_SESSION['customer']) || isset($_SESSION['seller'])) {
								?>
	...
	<div class="hamburger_menu" style="z-index: 100000;">
				...
				<li class="menu_item has-children">
					...
					<ul class="menu_selection">
						...
						?>
							...
							<li><a href="./registration.php"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
						<?php } ?>
					</ul>
				</li>
				<li class="menu_item"><a href="./index.php">Home</a></li>
				<li class="menu_item"><a href="./product-category.php?id=1&type=top-category">Shop</a></li>
				<li class="menu_item"><a href="./customer-order.php">History</a></li>
				<li class="menu_item"><a href="./select.php">Forum</a></li>
				<li class="menu_item"><a href="./image-upload.php">Image Upload</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<style>
					...
					.search-area form .form-group button {
						background: none;
						border: none;
						outline: none;
						margin: 0;
				...
				<div class="col-md-4 search-area">
					<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
						<?php $csrf->echoInputField(); ?>
						<div class="form-group">
							<input type="text" class="form-control search-top" placeholder="<?php echo "Search Product"; ?>" name="search_text" style="min-width: 155px;">
